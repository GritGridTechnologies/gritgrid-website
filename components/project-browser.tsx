...
import { FeaturedProject, ProjectCard, matchesProject } from "../lib/projects";
...
export default function ProjectBrowser() {
  ...
  return <>
    ...
    {filter === "All" && !query && <><FeaturedProject project={projects[0]} /><h2 className="other-projects-heading">Other Projects</h2></>}
    <div className="portfolio-grid">{visibleProjects.filter((project) => project.slug !== "gritgrid-official-website").map((project) => <ProjectCard project={project} key={project.slug} />)}</div>
