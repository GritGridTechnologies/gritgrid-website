...
export default function Home() {
  ...
  return (
    <main className="home-page">
      ...
      <section id="projects" className="section projects-preview"><div className="container"><SectionIntro eyebrow="Selected work" title="Selected Work"><p>Explore the products, platforms and digital experiences we build — including the technology behind GritGrid itself.</p></SectionIntro><FeaturedProject project={projects[0]} /><h3 className="other-projects-heading">Other Projects</h3><div className="portfolio-grid homepage-project-grid">{projects.slice(1).map((project) => <ProjectCard project={project} key={project.slug} />)}</div><a className="button button-primary view-all-projects" href="/projects">View All Projects →</a></div></section>
